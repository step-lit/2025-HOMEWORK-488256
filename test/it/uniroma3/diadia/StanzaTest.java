...
class StanzaTest {
	...
	public void setUp() {
		...
		stanzaTest.impostaStanzaAdiacente("nord", stanzaNord); //stanzaTest ha la direzione nord (verso stanzaNord)
		stanzaNord.impostaStanzaAdiacente("sud", stanzaTest); //stanzaNord ha la direzione sud (verso stanzaTest)
	...
	public void testgetStanzaAdiacente() {
		...
		assertNotNull(stanzaTest.getStanzaAdiacente("nord"));
        assertNull(stanzaTest.getStanzaAdiacente("sud"));
        assertNull(stanzaTest.getStanzaAdiacente("est"));
	...
	public void testImpostaStanzaAdiacenteNuovaNord() {
		...
		stanzaTest.impostaStanzaAdiacente("nord", nuovaNord);
		assertEquals(nuovaNord, stanzaTest.getStanzaAdiacente("nord"));
	}
	...
	public void testgetAttrezzoNull() {
		...
		assertNull(stanzaTest.getAttrezzo(test));
	}
	...
	public void testAddAttrezzoPiatto() {
		...
		assertTrue(stanzaTest.addAttrezzo(piatto));
		assertEquals(piatto, stanzaTest.getAttrezzo("Piatto"));
	}
	...
	public void testAddAttrezzoFull() {
		...
		assertFalse(stanzaTest.addAttrezzo(chiaveInglese));  //false perché l'array è pieno
		assertNull(stanzaTest.getAttrezzo("Chiave Inglese")); //null perché non è stato inserito
	}
	...
	public void testGetDirezioniNord() {
		...
		test[0] = "nord";
		assertArrayEquals(test, stanzaTest.getDirezioni());
	}
	...
	public void testGetDirezioniStanzaNord() {
		...
		assertTrue(stanzaNord.getDirezioni().length == 1);
	}
	...
	public void testRemoveAttrezzoNoAttrezzi() {
		...
		assertFalse(stanzaTest.removeAttrezzo("Martello"));
	}
	...
	public void testRemoveAttrezzo() {
		...
		stanzaTest.addAttrezzo(martello);
		assertTrue(stanzaTest.removeAttrezzo("Martello"));
	}
	...
	public void testRemoveAttrezzoNonPresente() {
		...
		stanzaTest.addAttrezzo(martello);
		assertFalse(stanzaTest.removeAttrezzo("a"));
	}
	
	@Test
	public void testRemoveAttrezzoInMezzo() {
		//rimuove un attrezzo in mezzo all'array
		stanzaTest.addAttrezzo(foglio);
		stanzaTest.addAttrezzo(torcia);
		stanzaTest.addAttrezzo(martello);
		assertTrue(stanzaTest.removeAttrezzo("Torcia"));
	}
